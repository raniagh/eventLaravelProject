    ...
    <div class="page-header card">
        <div class="card-block">
            ...
            <ul class="breadcrumb-title b-t-default p-t-10">
                ...
                <li class="breadcrumb-item"><a href="#!">activités en attente</a>
                </li>
            </ul>
        </div>
    </div>
                                ...
                                @foreach($activites as $activite)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('admin.activites.EnLigne', $activite->id_activite) }}" method="patch">
                                                 <input type="submit" value="Mettre en Ligne" class="btn btn-success btn-round" style="width: 100%" onclick="return confirm('Voulez-vous Vraiment mettre en ligne cette activité ?')">
                                            </form>
                                        </td>
                                    </tr>
                                @endforeach
