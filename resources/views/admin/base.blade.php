            ...
            <div class="navbar-wrapper">
                <div class="navbar-logo">
                    ...
                    <a href="/" style="margin-left: 22px;margin-top: -19px;">
                        <img class="img-fluid" src="{{URL::asset('assets\img\logo.png')}}" style="height: 30px;" alt="Theme-Logo" />
                    </a>
                ...
                <div class="navbar-container container-fluid">
                    ...
                    <ul class="nav-right">
                        ...
                        <li class="user-profile header-notification">
                            <a>
                                <span>bienvenue {!!Auth::guard('admin')->user()->name!!}</span>
                                ...
                                <ul class="pcoded-submenu">
                                    <li>
                                        <a href="{{ route('admin.activites.index')}}">
                                            <span class="pcoded-mtext">Toutes les produits</span>
                                        </a>
                                    </li>

                                   
                                    <li>
                                        <a href="{{ route('admin.activites.add')}}">
                                            <span class="pcoded-micon"><i class="icon-chart"></i></span>
                                            <span class="pcoded-mtext">Ajouter produit</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
